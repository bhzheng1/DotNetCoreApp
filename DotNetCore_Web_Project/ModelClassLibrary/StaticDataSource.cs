...
namespace ModelClassLibrary
{
    ...
    {
        public static IList<CountryModel> _countries { get; }
        ...
        static StaticDataSource()
        {
            ...
            _countries.Add(new CountryModel("USA", "United States", "North America"));
            _countries.Add(new CountryModel("CAN", "Canada", "North America"));
            _countries.Add(new CountryModel("CHN", "China", "Asia"));
            _countries.Add(new CountryModel("IND", "India", "Asia"));
        ...
        public static IList<CountryModel> Countries => _countries;
        ...
        public static Product GetProductByID(int id)
        {
            if (_products.ContainsKey(id))
            {
                ...
                result.Type = _productTypes[result.TypeID.Value];
                return result;
            }
            return null;
        }
